...
#define ALLOCATE_(ALLOCATOR, TYPE) allocate_((ALLOCATOR), sizeof(TYPE), _Alignof(TYPE))
#define ALLOCATE(ALLOCATOR, TYPE) allocate((ALLOCATOR), sizeof(TYPE), _Alignof(TYPE))
