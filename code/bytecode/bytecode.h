...
enum
{
    ...
    BYTECODE_LDR8_RA  = 0x4,
    BYTECODE_LDR16_RI = 0x5,
    BYTECODE_LDR16_RA = 0x6,
    BYTECODE_LDR32_RI = 0x7,
    BYTECODE_LDR32_RA = 0x8,
    BYTECODE_LDR64_RI = 0x9,
    BYTECODE_LDR64_RA = 0xa,
    BYTECODE_STR8_RI  = 0xb,
    BYTECODE_STR8_RA  = 0xc,
    BYTECODE_STR16_RI = 0xd,
    BYTECODE_STR16_RA = 0xe,
    BYTECODE_STR32_RI = 0xf,
    BYTECODE_STR32_RA = 0x10,
    BYTECODE_STR64_RI = 0x11,
